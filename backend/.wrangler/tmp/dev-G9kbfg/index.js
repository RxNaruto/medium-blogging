...
// .wrangler/tmp/bundle-pVZ78J/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/rithkchaudhary/Documents/medium-blogging/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "d4f1fe2a1970f5181da4980b2f493580a51855ceb03ef25115ad8cc8862115cf",
      "copyEngine": true
    };
    config.dirname = "/";
...
In case this error is unexpected for you, please report it in https://pris.ly/prisma-prisma-bug-report`
    ...
    var default_index_default = { Prisma: Prisma3 };
  }
});
...
// node_modules/@xznaruto/mediumwebs-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@xznaruto/mediumwebs-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-pVZ78J/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-pVZ78J/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_mediumwebs_common = __toESM(require_dist());
...
userRouter.post("/signup", async (c) => {
  ...
  const { success } = import_mediumwebs_common.signupInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      msg: "Incorrect input"
...
blogRouter.use("/*", async (c, next) => {
  ...
  const user = await verify2(authHeader, "secret");
  if (user) {
